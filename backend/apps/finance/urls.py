...
urlpatterns = [
    ...
    path("students/<uuid:student_id>/fee-statement/pdf/", StudentFeeStatementPdfView.as_view(), name="student-fee-statement-pdf"),
    path("students/<uuid:student_id>/fee-statement/email/", StudentFeeStatementEmailView.as_view(), name="student-fee-statement-email"),
