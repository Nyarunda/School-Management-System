...
- The ~110s clustered stall during postgres-connection-kill: **flagged for follow-up investigation**, not classified as a fixed defect or an accepted risk yet — the evidence (two independent corroborating signals) is strong enough that it shouldn't be dismissed, but the exact lock/mechanism wasn't conclusively isolated within this area's scope.
